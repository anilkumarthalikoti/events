...
define(['angularAMD', 'angular-route', 'ui-bootstrap', 'angular-sanitize', 'blockUI','jquery'  ], function (angularAMD) {
    ...
    app.config(['$routeProvider', function ($routeProvider) {
        ...
        $routeProvider
           ...
           .when("/", angularAMD.route({
                ...
                templateUrl: function (rp) {  return 'views/default/home.html';  },               
                controllerUrl: "controller/default/defaultController"            
